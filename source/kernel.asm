;YS --- The YS OS Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE YSOS_VER '1.0.0'	 ;OS version number
	%DEFINE YSOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as DoNOS and its programs
...
option_screen:
	...
	os_init_msg		db '*************Welcome to YS OS****************', 0
	os_version_msg		db 'Version ', YSOS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', YSOS_VER, 0

	dialog_string_1		db 'Welcome to YS Operating System', 0
...
os_draw_background1:
	...
	mov ah, 09h			; Draw yellow bar at top
	mov bh, 0
	mov cx, 80
	mov bl,11100001b
	mov al, ' '
	...
	mov ah, 09h			; Draw yellow bar at bottom
	mov bh, 0
	mov cx, 80
	mov bl, 11100001b
	mov al, ' '
